...
== Changelog ==
= 2.14.1 - 2026-07-11 =
* Aras Kargo talep anketi ve sipariş ekranı iyileştirmeleri

= 2.14.0 - 2026-07-02 =
* feat: add "Elif Su Uludağ" mahalle to Adana Sarıçam
...
* i18n(tr): translate Hepsijet PDF label product/order-note settings
= 2.13.0 - 2026-06-23 =
* feat: etikette sipariş notu alanını opsiyonel yap

= 2.12.0 - 2026-06-06 =
* feat(sms): NetGSM test gönderimi + SMS sağlayıcı/şablon revizyonu (→ develop)
...
= 2.8.0 - 2026-02-25 =
* Kargokit - Hepsijet toplu barkod özelliği eklendi.
* Belirli kargo firmalarını devre dışı bırakma özelliği eklendi.
* Manuel gönderi ayarı, manuel gönderi ayarları bölümüne taşındı.
* Sürat Kargo gönderi takip URL'si düzeltildi.
* Yeni mahalle eklendi (Mersin -> Tarsus -> Atatürk Mah.).
* Desi ondalık değeri normalize edildi.
...
* Sözleşmeler deki ürünler değişkenine nitelikler eklendi.
* Sözleşmeler deki ürünler değişkenin tablo olarak gösterilmesi sağlandı.
* Sözleşmeler deki ürünler değişkenindeki sütun isimlerinde değişiklik yapıldı.
* Sözleşmeler de wp_hezarfen_contracts tablosunun oluşmaması problemi giderildi.
...
= 2.6.6 - 2025-09-17 =
* Mesafeli satış sözleşmesi ve diğer sözleşmelerin oluşma zaman tercihinin yapılabilmesi için ayar eklendi. (sipariş oluştuğunda veya hazırlanıyor olduğunda sözleşmelerin oluşması sağlanabilir.)
* Hepsijet UI geliştirmesi

= 2.6.5 - 2025-09-16 =
* Abone ol kartının tüm WooCommerce ayarlarında çıkması problemi giderildi.
* Kargo modülünün aktif/pasifliği bilgisini yöneten option_name değiştirildi.
* Kargo takip ekranına eğitim videoları butonu eklendi.
...
= 2.3.3 - 2025-08-07 =
* Arayüzde minör iyileştirme
* wordpress.org yorum ricası
* Arayüzde performans iyileştirmesi
