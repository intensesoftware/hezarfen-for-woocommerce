...
<div class="hez-address-fields" data-hez-address-fields>
	...
	<p class="hez-field hez-field--first-name">
		<label for="hez-pickup-first-name"><?php esc_html_e( 'Ad', 'hezarfen-for-woocommerce' ); ?>&nbsp;<abbr class="required" title="<?php esc_attr_e( 'zorunlu', 'hezarfen-for-woocommerce' ); ?>">*</abbr></label>
	...
	<p class="hez-field hez-field--last-name">
		<label for="hez-pickup-last-name"><?php esc_html_e( 'Soyad', 'hezarfen-for-woocommerce' ); ?>&nbsp;<abbr class="required" title="<?php esc_attr_e( 'zorunlu', 'hezarfen-for-woocommerce' ); ?>">*</abbr></label>
	...
	<p class="hez-field hez-field--phone">
		<label for="hez-pickup-phone"><?php esc_html_e( 'Cep telefonu', 'hezarfen-for-woocommerce' ); ?>&nbsp;<abbr class="required" title="<?php esc_attr_e( 'zorunlu', 'hezarfen-for-woocommerce' ); ?>">*</abbr></label>
	...
	<p class="hez-field hez-field--city">
		<label for="hez-pickup-city"><?php esc_html_e( 'İl', 'hezarfen-for-woocommerce' ); ?>&nbsp;<abbr class="required" title="<?php esc_attr_e( 'zorunlu', 'hezarfen-for-woocommerce' ); ?>">*</abbr></label>
	...
	<p class="hez-field hez-field--district">
		<label for="hez-pickup-district"><?php esc_html_e( 'İlçe', 'hezarfen-for-woocommerce' ); ?>&nbsp;<abbr class="required" title="<?php esc_attr_e( 'zorunlu', 'hezarfen-for-woocommerce' ); ?>">*</abbr></label>
	...
	<p class="hez-field hez-field--neighborhood">
		<label for="hez-pickup-neighborhood"><?php esc_html_e( 'Mahalle', 'hezarfen-for-woocommerce' ); ?>&nbsp;<abbr class="required" title="<?php esc_attr_e( 'zorunlu', 'hezarfen-for-woocommerce' ); ?>">*</abbr></label>
	...
	<p class="hez-field hez-field--address">
		<label for="hez-pickup-address"><?php esc_html_e( 'Açık adres', 'hezarfen-for-woocommerce' ); ?>&nbsp;<abbr class="required" title="<?php esc_attr_e( 'zorunlu', 'hezarfen-for-woocommerce' ); ?>">*</abbr></label>
